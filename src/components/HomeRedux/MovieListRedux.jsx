...
const MovieListRedux = ({
  listName, listKey, allGenres, moviesList,
}) => {
  const classes = useStyles();
  const moviesData = useMemo(() => moviesList[listKey].value, [listKey, moviesList]);
...
const mapStateToProps = (state) => ({ moviesList: state.movies.lists });

export default connect(mapStateToProps)(MovieListRedux);
